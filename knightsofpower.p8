...
function interact(x,y)
	...
	--check for fight
	if targetx==8 and targety==14 then
...
function draw_battle()
	cls()
	--screen
	rectfill(60,10,100,50,3)
	spr(166,74,20)
	--enemy
	print(battle.enemy.name,60,55,7)
	draw_hp_bar(60,62,battle.enemy.hp,battle.enemy.maxhp,8)
	--player
	print("????",4,80,7)
	draw_hp_bar(4,87,p.hp,p.maxhp,11)
	--message box
	...
	if battle.state==battle_state.win or battle.state==battle_state.lose then
		...
		print(battle.message,44,60,col)
	end
end

function draw_hp_bar(x,y,hp,maxhp,col)
	local w=40
	rect(x,y,x+w,y+4,7)
	local fill=flr((hp/maxhp)*w)
	rectfill(x+1,y+1,x+fill,y+3,col)
	print(hp.."/"..maxhp,x+w+2,y,7)
end
__gfx__
...

...

__label__
